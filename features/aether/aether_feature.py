...
class OneStepAetherPipeline(AetherV1PipelineCogVideoX):
    ...
    def __call__(
        ...
        _, all_hidden_states = self.transformer(
            hidden_states=latent_model_input,
...
class AetherFeaturizer:
    ...
    def __init__(self):
        ...
        """
        cogvideox_model_id = "ckpt/CogVideoX-5b-I2V"
        aether_model_id = "ckpt/AetherV1"
        pipeline = OneStepAetherPipeline(
            ...
            text_encoder=T5EncoderModel.from_pretrained(
                cogvideox_model_id, subfolder="text_encoder"
            ),
            ...
            scheduler=CogVideoXDPMScheduler.from_pretrained(
                cogvideox_model_id, subfolder="scheduler"
            ),
