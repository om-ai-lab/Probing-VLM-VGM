...
# run in bash:
# for file in data/DL3DV/DL3DV-processed/1K/0*.sft; do hash=$(basename "$file" .sft); CUDA_VISIBLE_DEVICES=0 python -m probing_vlm_vgm.data.processing.visualize_sft --sft "$file" --output data/DL3DV/DL3DV-10K/test_output/"$hash"; done
