    ...
    def forward(
        ...
        for i, block in enumerate(self.blocks):
            ...
            if output_hidden_states or (
                ...
                # Keep a detached reference; cloning every requested layer is
                # expensive for 14B and is unnecessary because later blocks
                # produce new tensors rather than mutating this one in-place.
                all_hidden_states[i] = hidden_states.detach()
...
def get_wan_featurizer(
    ...
    """
    return WanFeaturizer(model_id=model_id, null_prompt=null_prompt)
